...
export function animateScrollWithGSAP(
  target: string,
  animationProps: { [key: string]: string | number | {(): void} },
  scrollProps?: { [key: string]: string | number | {(): void} },
...
export function animateWithGSAPTimeline(
  ...
  firstTarget: string,
  secondTarget: string,
  animProps: { [key: string]: string | number }
): void {
